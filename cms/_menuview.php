	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_menu"] <> "") {
				...
				$this->RecKey["id_menu"] = $this->id_menu->QueryStringValue;
			} else {
...
f_menuview.Lists["x_id_idioma"] = {"LinkField":"x_id_idioma","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php echo $_menu->id_menu->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($_menu->id_idioma->Visible) { // id_idioma ?>
	<tr id="r_id_idioma">
		<td><span id="elh__menu_id_idioma"><?php echo $_menu->id_idioma->FldCaption() ?></span></td>
...
<?php echo $_menu->id_idioma->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($_menu->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh__menu_descripcion"><?php echo $_menu->descripcion->FldCaption() ?></span></td>
...
<?php echo $_menu->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($_menu->amigable->Visible) { // amigable ?>
	<tr id="r_amigable">
		<td><span id="elh__menu_amigable"><?php echo $_menu->amigable->FldCaption() ?></span></td>
...
<?php echo $_menu->amigable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
