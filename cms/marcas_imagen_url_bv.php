...
$marcas_imagen_url_blobview = NULL; // Initialize page object first

class cmarcas_imagen_url_blobview extends cmarcas {
	...
	// Page object name
	var $PageObjName = 'marcas_imagen_url_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('marcas', 'x_imagen_url');
...
// Create page object
if (!isset($marcas_imagen_url_blobview)) $marcas_imagen_url_blobview = new cmarcas_imagen_url_blobview();

// Page init
$marcas_imagen_url_blobview->Page_Init();

// Page main
$marcas_imagen_url_blobview->Page_Main();
?>
<?php
$marcas_imagen_url_blobview->Page_Terminate();
?>
