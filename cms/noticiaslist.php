...
class cnoticias_list extends cnoticias {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->id_noticia->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->id_noticia->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label class=\"checkbox\"><input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_noticia->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'></label>";
...
fnoticiaslist.Lists["x_id_idioma"] = {"LinkField":"x_id_idioma","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};

// Form object for search
var fnoticiaslistsrch = new ew_Form("fnoticiaslistsrch");
</script>
<style type="text/css">
...
<form name="fnoticiaslistsrch" id="fnoticiaslistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<div class="accordion ewDisplayTable ewSearchTable" id="fnoticiaslistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#fnoticiaslistsrch_SearchGroup" href="#fnoticiaslistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="fnoticiaslistsrch_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">
<div id="fnoticiaslistsrch_SearchPanel">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($noticias_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $noticias_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
	</div>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($noticias_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($noticias_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($noticias_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<?php if ($noticias->id_idioma->Visible) { // id_idioma ?>
	<?php if ($noticias->SortUrl($noticias->id_idioma) == "") { ?>
		<td><div id="elh_noticias_id_idioma" class="noticias_id_idioma"><div class="ewTableHeaderCaption"><?php echo $noticias->id_idioma->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $noticias->SortUrl($noticias->id_idioma) ?>',2);"><div id="elh_noticias_id_idioma" class="noticias_id_idioma">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $noticias->id_idioma->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($noticias->id_idioma->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($noticias->id_idioma->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($noticias->fecha->Visible) { // fecha ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $noticias->SortUrl($noticias->fecha) ?>',2);"><div id="elh_noticias_fecha" class="noticias_fecha">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $noticias->fecha->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($noticias->fecha->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($noticias->fecha->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($noticias->titulo->Visible) { // titulo ?>
	...
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $noticias->SortUrl($noticias->titulo) ?>',2);"><div id="elh_noticias_titulo" class="noticias_titulo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $noticias->titulo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($noticias->titulo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($noticias->titulo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
