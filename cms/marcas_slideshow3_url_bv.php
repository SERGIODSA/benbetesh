...
$marcas_slideshow3_url_blobview = NULL; // Initialize page object first

class cmarcas_slideshow3_url_blobview extends cmarcas {
	...
	// Page object name
	var $PageObjName = 'marcas_slideshow3_url_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('marcas', 'x_slideshow3_url');
...
// Create page object
if (!isset($marcas_slideshow3_url_blobview)) $marcas_slideshow3_url_blobview = new cmarcas_slideshow3_url_blobview();

// Page init
$marcas_slideshow3_url_blobview->Page_Init();

// Page main
$marcas_slideshow3_url_blobview->Page_Main();
?>
<?php
$marcas_slideshow3_url_blobview->Page_Terminate();
?>
