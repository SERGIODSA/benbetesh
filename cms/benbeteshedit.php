...
$benbetesh_edit = NULL; // Initialize page object first

class cbenbetesh_edit extends cbenbetesh {
	...
	// Page object name
	var $PageObjName = 'benbetesh_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_tienda->CurrentValue == "")
			$this->Page_Terminate("benbeteshlist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// horario
			$this->horario->SetDbValueDef($rsnew, $this->horario->CurrentValue, "", $this->horario->ReadOnly);
...
// Create page object
if (!isset($benbetesh_edit)) $benbetesh_edit = new cbenbetesh_edit();

// Page init
$benbetesh_edit->Page_Init();

// Page main
$benbetesh_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$benbetesh_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var benbetesh_edit = new ew_Page("benbetesh_edit");
benbetesh_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = benbetesh_edit.PageID; // For backward compatibility

// Form object
var fbenbeteshedit = new ew_Form("fbenbeteshedit");

// Validate form
fbenbeteshedit.Validate = function() {
...
fbenbeteshedit.Form_CustomValidate = 
...
fbenbeteshedit.ValidateRequired = true;
<?php } else { ?>
fbenbeteshedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fbenbeteshedit.Lists["x_id_idioma"] = {"LinkField":"x_id_idioma","Ajax":null,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $benbetesh_edit->ShowPageHeader(); ?>
<?php
$benbetesh_edit->ShowMessage();
?>
<form name="fbenbeteshedit" id="fbenbeteshedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="benbetesh">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_benbeteshedit" class="table table-bordered table-striped">
...
<script type="text/javascript">
fbenbeteshedit.Lists["x_id_idioma"].Options = <?php echo (is_array($benbetesh->id_idioma->EditValue)) ? ew_ArrayToJson($benbetesh->id_idioma->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="hidden" data-field="x_id_tienda" name="x_id_tienda" id="x_id_tienda" value="<?php echo ew_HtmlEncode($benbetesh->id_tienda->CurrentValue) ?>">
