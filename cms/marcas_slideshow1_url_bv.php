...
$marcas_slideshow1_url_blobview = NULL; // Initialize page object first

class cmarcas_slideshow1_url_blobview extends cmarcas {
	...
	// Page object name
	var $PageObjName = 'marcas_slideshow1_url_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('marcas', 'x_slideshow1_url');
...
// Create page object
if (!isset($marcas_slideshow1_url_blobview)) $marcas_slideshow1_url_blobview = new cmarcas_slideshow1_url_blobview();

// Page init
$marcas_slideshow1_url_blobview->Page_Init();

// Page main
$marcas_slideshow1_url_blobview->Page_Main();
?>
<?php
$marcas_slideshow1_url_blobview->Page_Terminate();
?>
