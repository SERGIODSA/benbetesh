...
define("EW_PROJECT_NAME", "cms2Dbenbetesh", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{56E3A665-834A-4135-82FE-063C92D89B0C}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '2rndAxr0LYM2c3hu', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/cms2Dbenbetesh.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'benbetesh', TRUE);
...
define("EW_ADMIN_PASSWORD", "b3nb3t3sh", TRUE); // Administrator password
...
// File upload
define("EW_UPLOAD_DEST_PATH", "../subidas/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "jpg,jpeg,png", TRUE); // Allowed file extensions
...
?>
<?php
define("EW_CAPTCHA_FONT", "aftershock", TRUE);
?>
<?php
