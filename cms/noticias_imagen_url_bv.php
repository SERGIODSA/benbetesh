...
$noticias_imagen_url_blobview = NULL; // Initialize page object first

class cnoticias_imagen_url_blobview extends cnoticias {
	...
	// Page object name
	var $PageObjName = 'noticias_imagen_url_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('noticias', 'x_imagen_url');
...
// Create page object
if (!isset($noticias_imagen_url_blobview)) $noticias_imagen_url_blobview = new cnoticias_imagen_url_blobview();

// Page init
$noticias_imagen_url_blobview->Page_Init();

// Page main
$noticias_imagen_url_blobview->Page_Main();
?>
<?php
$noticias_imagen_url_blobview->Page_Terminate();
?>
