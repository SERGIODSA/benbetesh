...
$nosotros_add = NULL; // Initialize page object first

class cnosotros_add extends cnosotros {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_nosotros"] != "") {
				...
				$this->setKey("id_nosotros", $this->id_nosotros->CurrentValue); // Set up key
			} else {
				$this->setKey("id_nosotros", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "nosotrosview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($AddRow) {
			$this->id_nosotros->setDbValue($conn->Insert_ID());
			$rsnew['id_nosotros'] = $this->id_nosotros->DbValue;
		}
		if ($AddRow) {
...
// Create page object
if (!isset($nosotros_add)) $nosotros_add = new cnosotros_add();

// Page init
$nosotros_add->Page_Init();

// Page main
$nosotros_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$nosotros_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var nosotros_add = new ew_Page("nosotros_add");
nosotros_add.PageID = "add"; // Page ID
var EW_PAGE_ID = nosotros_add.PageID; // For backward compatibility

// Form object
var fnosotrosadd = new ew_Form("fnosotrosadd");

// Validate form
fnosotrosadd.Validate = function() {
...
fnosotrosadd.Form_CustomValidate = 
...
fnosotrosadd.ValidateRequired = true;
<?php } else { ?>
fnosotrosadd.ValidateRequired = false; 
<?php } ?>
...
<?php $nosotros_add->ShowPageHeader(); ?>
<?php
$nosotros_add->ShowMessage();
?>
<form name="fnosotrosadd" id="fnosotrosadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="nosotros">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_nosotrosadd" class="table table-bordered table-striped">
</table>
</td></tr></table>
