...
$benbetesh_imagen_url_blobview = NULL; // Initialize page object first

class cbenbetesh_imagen_url_blobview extends cbenbetesh {
	...
	// Page object name
	var $PageObjName = 'benbetesh_imagen_url_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('benbetesh', 'x_imagen_url');
...
// Create page object
if (!isset($benbetesh_imagen_url_blobview)) $benbetesh_imagen_url_blobview = new cbenbetesh_imagen_url_blobview();

// Page init
$benbetesh_imagen_url_blobview->Page_Init();

// Page main
$benbetesh_imagen_url_blobview->Page_Main();
?>
<?php
$benbetesh_imagen_url_blobview->Page_Terminate();
?>
