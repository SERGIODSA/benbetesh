...
$nosotros_view = NULL; // Initialize page object first

class cnosotros_view extends cnosotros {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["id_nosotros"] <> "") {
			$this->RecKey["id_nosotros"] = $_GET["id_nosotros"];
			$KeyUrl .= "&amp;id_nosotros=" . urlencode($this->RecKey["id_nosotros"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_nosotros"] <> "") {
				...
				$this->RecKey["id_nosotros"] = $this->id_nosotros->QueryStringValue;
			} else {
				$sReturnUrl = "nosotroslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "nosotroslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "nosotroslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($nosotros_view)) $nosotros_view = new cnosotros_view();

// Page init
$nosotros_view->Page_Init();

// Page main
$nosotros_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$nosotros_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var nosotros_view = new ew_Page("nosotros_view");
nosotros_view.PageID = "view"; // Page ID
var EW_PAGE_ID = nosotros_view.PageID; // For backward compatibility

// Form object
var fnosotrosview = new ew_Form("fnosotrosview");

// Form_CustomValidate event
fnosotrosview.Form_CustomValidate = 
...
fnosotrosview.ValidateRequired = true;
<?php } else { ?>
fnosotrosview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fnosotrosview.Lists["x_id_idioma"] = {"LinkField":"x_id_idioma","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $nosotros_view->ExportOptions->Render("body") ?>
<?php if (!$nosotros_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($nosotros_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $nosotros_view->ShowPageHeader(); ?>
<?php
$nosotros_view->ShowMessage();
?>
<form name="fnosotrosview" id="fnosotrosview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="nosotros">
<table class="ewGrid"><tr><td>
<table id="tbl_nosotrosview" class="table table-bordered table-striped">
...
<?php echo $nosotros->id_idioma->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nosotros->imagen1_url->Visible) { // imagen1_url ?>
	<tr id="r_imagen1_url">
		<td><span id="elh_nosotros_imagen1_url"><?php echo $nosotros->imagen1_url->FldCaption() ?></span></td>
		<td<?php echo $nosotros->imagen1_url->CellAttributes() ?>>
<span id="el_nosotros_imagen1_url" class="control-group">
<span<?php echo $nosotros->imagen1_url->ViewAttributes() ?>>
<?php if ($nosotros->imagen1_url->LinkAttributes() <> "") { ?>
<?php if (!empty($nosotros->imagen1_url->Upload->DbValue)) { ?>
<?php echo $nosotros->imagen1_url->ViewValue ?>
<?php } elseif (!in_array($nosotros->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
<?php if (!empty($nosotros->imagen1_url->Upload->DbValue)) { ?>
...
<?php if ($nosotros->imagen2_url->Visible) { // imagen2_url ?>
	<tr id="r_imagen2_url">
		<td><span id="elh_nosotros_imagen2_url"><?php echo $nosotros->imagen2_url->FldCaption() ?></span></td>
		<td<?php echo $nosotros->imagen2_url->CellAttributes() ?>>
<span id="el_nosotros_imagen2_url" class="control-group">
<span<?php echo $nosotros->imagen2_url->ViewAttributes() ?>>
<?php if ($nosotros->imagen2_url->LinkAttributes() <> "") { ?>
<?php if (!empty($nosotros->imagen2_url->Upload->DbValue)) { ?>
<?php echo $nosotros->imagen2_url->ViewValue ?>
<?php } elseif (!in_array($nosotros->CurrentAction, array("I", "edit", "gridedit"))) { ?>	
&nbsp;
<?php } ?>
<?php } else { ?>
...
<?php if ($nosotros->titulo1->Visible) { // titulo1 ?>
	<tr id="r_titulo1">
		<td><span id="elh_nosotros_titulo1"><?php echo $nosotros->titulo1->FldCaption() ?></span></td>
...
<?php echo $nosotros->titulo1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nosotros->descripcion1->Visible) { // descripcion1 ?>
	<tr id="r_descripcion1">
		<td><span id="elh_nosotros_descripcion1"><?php echo $nosotros->descripcion1->FldCaption() ?></span></td>
		<td<?php echo $nosotros->descripcion1->CellAttributes() ?>>
<span id="el_nosotros_descripcion1" class="control-group">
<span<?php echo $nosotros->descripcion1->ViewAttributes() ?>>
<?php echo $nosotros->descripcion1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nosotros->titulo2->Visible) { // titulo2 ?>
	<tr id="r_titulo2">
		<td><span id="elh_nosotros_titulo2"><?php echo $nosotros->titulo2->FldCaption() ?></span></td>
...
<?php echo $nosotros->titulo2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nosotros->descripcion2->Visible) { // descripcion2 ?>
	<tr id="r_descripcion2">
		<td><span id="elh_nosotros_descripcion2"><?php echo $nosotros->descripcion2->FldCaption() ?></span></td>
		<td<?php echo $nosotros->descripcion2->CellAttributes() ?>>
<span id="el_nosotros_descripcion2" class="control-group">
<span<?php echo $nosotros->descripcion2->ViewAttributes() ?>>
<?php echo $nosotros->descripcion2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nosotros->titulo3->Visible) { // titulo3 ?>
	<tr id="r_titulo3">
		<td><span id="elh_nosotros_titulo3"><?php echo $nosotros->titulo3->FldCaption() ?></span></td>
...
<?php echo $nosotros->titulo3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($nosotros->descripcion3->Visible) { // descripcion3 ?>
	<tr id="r_descripcion3">
		<td><span id="elh_nosotros_descripcion3"><?php echo $nosotros->descripcion3->FldCaption() ?></span></td>
		<td<?php echo $nosotros->descripcion3->CellAttributes() ?>>
<span id="el_nosotros_descripcion3" class="control-group">
<span<?php echo $nosotros->descripcion3->ViewAttributes() ?>>
<?php echo $nosotros->descripcion3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
