...
f_menudelete.Lists["x_id_idioma"] = {"LinkField":"x_id_idioma","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($_menu->id_idioma->Visible) { // id_idioma ?>
		<td><span id="elh__menu_id_idioma" class="_menu_id_idioma"><?php echo $_menu->id_idioma->FldCaption() ?></span></td>
<?php } ?>
<?php if ($_menu->descripcion->Visible) { // descripcion ?>
		<td><span id="elh__menu_descripcion" class="_menu_descripcion"><?php echo $_menu->descripcion->FldCaption() ?></span></td>
<?php } ?>
<?php if ($_menu->amigable->Visible) { // amigable ?>
		<td><span id="elh__menu_amigable" class="_menu_amigable"><?php echo $_menu->amigable->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $p_menu_delete->RowCnt ?>__menu_id_idioma" class="control-group _menu_id_idioma">
...
<span id="el<?php echo $p_menu_delete->RowCnt ?>__menu_descripcion" class="control-group _menu_descripcion">
...
<span id="el<?php echo $p_menu_delete->RowCnt ?>__menu_amigable" class="control-group _menu_amigable">
