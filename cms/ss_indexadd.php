...
$ss_index_add = NULL; // Initialize page object first

class css_index_add extends css_index {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_ssindex"] != "") {
				...
				$this->setKey("id_ssindex", $this->id_ssindex->CurrentValue); // Set up key
			} else {
				$this->setKey("id_ssindex", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "ss_indexview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($AddRow) {
			$this->id_ssindex->setDbValue($conn->Insert_ID());
			$rsnew['id_ssindex'] = $this->id_ssindex->DbValue;
		}
		if ($AddRow) {
...
// Create page object
if (!isset($ss_index_add)) $ss_index_add = new css_index_add();

// Page init
$ss_index_add->Page_Init();

// Page main
$ss_index_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ss_index_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var ss_index_add = new ew_Page("ss_index_add");
ss_index_add.PageID = "add"; // Page ID
var EW_PAGE_ID = ss_index_add.PageID; // For backward compatibility

// Form object
var fss_indexadd = new ew_Form("fss_indexadd");

// Validate form
fss_indexadd.Validate = function() {
...
fss_indexadd.Form_CustomValidate = 
...
fss_indexadd.ValidateRequired = true;
<?php } else { ?>
fss_indexadd.ValidateRequired = false; 
<?php } ?>
...
<?php $ss_index_add->ShowPageHeader(); ?>
<?php
$ss_index_add->ShowMessage();
?>
<form name="fss_indexadd" id="fss_indexadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="ss_index">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_ss_indexadd" class="table table-bordered table-striped">
</table>
</td></tr></table>
