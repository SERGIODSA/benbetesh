...
function CurrentProjectID() {
	...
	return "{56E3A665-834A-4135-82FE-063C92D89B0C}";
}
...
?>
<?php
include_once 'phpexcel179/Classes/PHPExcel.php';
...
class cExportExcel5 extends cExportBase {
	...
	function ExportAggregate(&$fld, $type) {
		...
		if ($this->Horizontal) {
			...
			$this->phpexcel->getActiveSheet()->setCellValueByColumnAndRow($this->FldCnt - 1, $this->RowCnt, $val);
		}
	}
	...
	function ExportCaptionBy(&$fld, $col, $row) {
		...
		$this->phpexcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $val); // Plain text
	}
