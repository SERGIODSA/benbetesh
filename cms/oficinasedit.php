...
$oficinas_edit = NULL; // Initialize page object first

class coficinas_edit extends coficinas {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_oficina->CurrentValue == "")
			$this->Page_Terminate("oficinaslist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		if (!$this->id_oficina->FldIsDetailKey)
			$this->id_oficina->setFormValue($objForm->GetValue("x_id_oficina"));
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->LoadRow();
		$this->id_oficina->CurrentValue = $this->id_oficina->FormValue;
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// lugar_titulo
			$this->lugar_titulo->SetDbValueDef($rsnew, $this->lugar_titulo->CurrentValue, "", $this->lugar_titulo->ReadOnly);
			...
			// tienda
			$this->tienda->SetDbValueDef($rsnew, $this->tienda->CurrentValue, NULL, $this->tienda->ReadOnly);
...
// Create page object
if (!isset($oficinas_edit)) $oficinas_edit = new coficinas_edit();

// Page init
$oficinas_edit->Page_Init();

// Page main
$oficinas_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$oficinas_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var oficinas_edit = new ew_Page("oficinas_edit");
oficinas_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = oficinas_edit.PageID; // For backward compatibility

// Form object
var foficinasedit = new ew_Form("foficinasedit");

// Validate form
foficinasedit.Validate = function() {
...
foficinasedit.Form_CustomValidate = 
...
foficinasedit.ValidateRequired = true;
<?php } else { ?>
foficinasedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
foficinasedit.Lists["x_id_idioma"] = {"LinkField":"x_id_idioma","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $oficinas_edit->ShowPageHeader(); ?>
<?php
$oficinas_edit->ShowMessage();
?>
<form name="foficinasedit" id="foficinasedit" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="oficinas">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_oficinasedit" class="table table-bordered table-striped">
...
<script type="text/javascript">
ew_CreateEditor("foficinasedit", "x_direccion", 0, 0, <?php echo ($oficinas->direccion->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<input type="hidden" data-field="x_id_oficina" name="x_id_oficina" id="x_id_oficina" value="<?php echo ew_HtmlEncode($oficinas->id_oficina->CurrentValue) ?>">
