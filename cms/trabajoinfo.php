...
//
// Table class for trabajo
//
class ctrabajo extends cTable {
	var $id_trabajo;
	var $id_idioma;
	var $titulo1;
	var $descripcion1;
	...
	function __construct() {
		...
		// id_trabajo
		$this->id_trabajo = new cField('trabajo', 'trabajo', 'x_id_trabajo', 'id_trabajo', '`id_trabajo`', '`id_trabajo`', 18, -1, FALSE, '`id_trabajo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_trabajo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_trabajo'] = &$this->id_trabajo;

		// id_idioma
		$this->id_idioma = new cField('trabajo', 'trabajo', 'x_id_idioma', 'id_idioma', '`id_idioma`', '`id_idioma`', 18, -1, FALSE, '`id_idioma`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_idioma->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_idioma'] = &$this->id_idioma;

		// titulo1
		$this->titulo1 = new cField('trabajo', 'trabajo', 'x_titulo1', 'titulo1', '`titulo1`', '`titulo1`', 200, -1, FALSE, '`titulo1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['titulo1'] = &$this->titulo1;

		// descripcion1
		$this->descripcion1 = new cField('trabajo', 'trabajo', 'x_descripcion1', 'descripcion1', '`descripcion1`', '`descripcion1`', 201, -1, FALSE, '`descripcion1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descripcion1'] = &$this->descripcion1;

		// titulo2
		$this->titulo2 = new cField('trabajo', 'trabajo', 'x_titulo2', 'titulo2', '`titulo2`', '`titulo2`', 200, -1, FALSE, '`titulo2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['titulo2'] = &$this->titulo2;

		// descripcion2
		$this->descripcion2 = new cField('trabajo', 'trabajo', 'x_descripcion2', 'descripcion2', '`descripcion2`', '`descripcion2`', 201, -1, FALSE, '`descripcion2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function DeleteSQL(&$rs, $where = "") {
		...
		if ($rs) {
			if (array_key_exists('id_trabajo', $rs))
				ew_AddFilter($where, ew_QuotedName('id_trabajo') . '=' . ew_QuotedValue($rs['id_trabajo'], $this->id_trabajo->FldDataType));
		}
		$filter = $this->CurrentFilter;
		ew_AddFilter($filter, $where);
		if ($filter <> "")
	...
	function KeyFilter() {
		...
		if (!is_numeric($this->id_trabajo->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@id_trabajo@", ew_AdjustSql($this->id_trabajo->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("trabajoview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("trabajoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "trabajoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("trabajoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("trabajoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("trabajodelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->id_trabajo->CurrentValue)) {
			$sUrl .= "id_trabajo=" . urlencode($this->id_trabajo->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["id_trabajo"]; // id_trabajo
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->id_trabajo->CurrentValue = $key;
   ...
   // Common render codes
		...
		$this->id_trabajo->ViewValue = $this->id_trabajo->CurrentValue;
		$this->id_trabajo->ViewCustomAttributes = "";
		...
		// id_trabajo
		$this->id_trabajo->LinkCustomAttributes = "";
		$this->id_trabajo->HrefValue = "";
		$this->id_trabajo->TooltipValue = "";
