...
class cp_menu_list extends c_menu {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->id_menu->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->id_menu->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label class=\"checkbox\"><input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_menu->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'></label>";
	...
	function RenderRow() {
		...
		$this->tienda->CellCssStyle = "white-space: nowrap;";
...
f_menulist.Lists["x_id_idioma"] = {"LinkField":"x_id_idioma","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($_menu->id_idioma->Visible) { // id_idioma ?>
	<?php if ($_menu->SortUrl($_menu->id_idioma) == "") { ?>
		<td><div id="elh__menu_id_idioma" class="_menu_id_idioma"><div class="ewTableHeaderCaption"><?php echo $_menu->id_idioma->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $_menu->SortUrl($_menu->id_idioma) ?>',2);"><div id="elh__menu_id_idioma" class="_menu_id_idioma">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $_menu->id_idioma->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($_menu->id_idioma->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($_menu->id_idioma->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($_menu->descripcion->Visible) { // descripcion ?>
	<?php if ($_menu->SortUrl($_menu->descripcion) == "") { ?>
		<td><div id="elh__menu_descripcion" class="_menu_descripcion"><div class="ewTableHeaderCaption"><?php echo $_menu->descripcion->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $_menu->SortUrl($_menu->descripcion) ?>',2);"><div id="elh__menu_descripcion" class="_menu_descripcion">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $_menu->descripcion->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($_menu->descripcion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($_menu->descripcion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($_menu->amigable->Visible) { // amigable ?>
	<?php if ($_menu->SortUrl($_menu->amigable) == "") { ?>
		<td><div id="elh__menu_amigable" class="_menu_amigable"><div class="ewTableHeaderCaption"><?php echo $_menu->amigable->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $_menu->SortUrl($_menu->amigable) ?>',2);"><div id="elh__menu_amigable" class="_menu_amigable">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $_menu->amigable->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($_menu->amigable->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($_menu->amigable->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<span<?php echo $_menu->id_idioma->ViewAttributes() ?>>
<?php echo $_menu->id_idioma->ListViewValue() ?></span>
<a id="<?php echo $p_menu_list->PageObjName . "_row_" . $p_menu_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($_menu->descripcion->Visible) { // descripcion ?>
		<td<?php echo $_menu->descripcion->CellAttributes() ?>>
<span<?php echo $_menu->descripcion->ViewAttributes() ?>>
<?php echo $_menu->descripcion->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($_menu->amigable->Visible) { // amigable ?>
		<td<?php echo $_menu->amigable->CellAttributes() ?>>
<span<?php echo $_menu->amigable->ViewAttributes() ?>>
<?php echo $_menu->amigable->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php
...
<!--first page button-->
	...
	<a class="btn btn-small" href="<?php echo $p_menu_list->PageUrl() ?>start=<?php echo $p_menu_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($p_menu_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $p_menu_list->PageUrl() ?>start=<?php echo $p_menu_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $p_menu_list->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($p_menu_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $p_menu_list->PageUrl() ?>start=<?php echo $p_menu_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($p_menu_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $p_menu_list->PageUrl() ?>start=<?php echo $p_menu_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $p_menu_list->Pager->PageCount ?>
</td>
<td>
	&nbsp;&nbsp;&nbsp;&nbsp;
